...
fun PermissionFlowScreen(
    ...
    Column(
        ...
        Text(
            text = "نحتاج للوصول إلى الإشعارات لنتمكن من تسجيل مصروفاتك تلقائياً وبدقة.",
        ...
        val infiniteTransition = rememberInfiniteTransition(label = "permission_anim")
                ...
                Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
                    ...
                    Row(
                        ...
                        Box(
                            modifier = Modifier
                                .size(32.dp)
                                .background(Color(0xFFBD001B), RoundedCornerShape(8.dp)),
                            contentAlignment = Alignment.Center
                        ) {
                            Icon(imageVector = Icons.Rounded.Money, contentDescription = null, tint = Color.White, modifier = Modifier.size(16.dp))
                        }
                    ...
                    Box(
                        ...
                        Column {
                            Row(
                                ...
                                Icon(imageVector = Icons.Rounded.NotificationsActive, contentDescription = null, tint = Color(0xFFBD001B), modifier = Modifier.size(20.dp))
                                Text(
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            Icon(imageVector = Icons.Rounded.AccountBalanceWallet, contentDescription = null, tint = Color(0xFFD2DBE4), modifier = Modifier.size(16.dp))
                        }
                        Column(horizontalAlignment = Alignment.End) {
                            Box(modifier = Modifier.width(60.dp).height(6.dp).background(Color(0xFFD2DBE4), RoundedCornerShape(3.dp)))
                            Spacer(modifier = Modifier.height(6.dp))
        ...
        if (!hasPermission) {
            ...
            Button(
                ...
                Text("فتح إعدادات الإشعارات", style = MaterialTheme.typography.labelLarge.copy(fontWeight = FontWeight.Bold))
            }
        }
