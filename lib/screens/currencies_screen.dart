...
class _CurrenciesScreenState extends State<CurrenciesScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('خطأ في تحميل العملات: $e'),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              ...
                              elevation: currency.isDefault ? 4 : 1,
                                ...
                                leading: CircleAvatar(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                                      color: currency.isDefault ? Colors.white : Theme.of(context).primaryColor,
                                    ),
                                  ),
                                ),
                                title: Row(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: currency.isDefault ? Theme.of(context).primaryColor : null,
                                      ),
                                    ),
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: currency.isDefault ? null : () => _deleteCurrency(currency),
                                    ),
                                  ],
                                ),
                              ),
  ...
  void _editCurrency(CurrencyModel currency) {
            ...
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'يرجى إدخال اسم العملة بالعربية';
                    }
                    return null;
                  },
                ),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'اسم العملة بالإنجليزية',
                    border: OutlineInputBorder(),
                    prefixIcon: Icon(Icons.abc),
                    hintText: 'Saudi Riyal',
                  ),
                  validator: (value) {
                    if (value == null || value.trim().isEmpty) {
                      return 'يرجى إدخال اسم العملة بالإنجليزية';
                    }
                    return null;
                  },
                ),
              ...
              if (formKey.currentState!.validate()) {
                try {
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(isEditing ? 'تم تعديل العملة بنجاح' : 'تم إضافة العملة بنجاح'),
            ...
            onPressed: () async {
              try {
                ...
                if (mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('تم تعيين العملة الافتراضية بنجاح'),
                      backgroundColor: Colors.green,
                    ),
                  );
                }
            ...
            onPressed: () async {
              try {
                ...
                if (mounted) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('خطأ في حذف العملة: $e'),
                      backgroundColor: Colors.red,
                    ),
                  );
                }
