              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      children: [
                        Expanded(flex: 3, child: Text('المبلغ', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold))),
                        Expanded(flex: 4, child: Text('تفاصيل', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold))),
                        Expanded(flex: 3, child: Text('التاريخ', textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold))),
                      ],
                    ),
                  ),
                ),
                      ...
                      ? const Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 16),
                              Text('لا توجد معاملات لهذا الحساب', style: TextStyle(fontSize: 18, color: Colors.grey)),
                              SizedBox(height: 8),
                              Text('اضغط على + لإضافة معاملة جديدة', style: TextStyle(fontSize: 14, color: Colors.grey)),
                            ],
                          ),
                        )
                      : ListView.builder(
