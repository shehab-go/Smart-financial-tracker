                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text('${_formatDate(modified)} · $sizeKB KB'),
                        trailing: Row(
                          ...
                          children: [
                              ...
                              onPressed: () async {
                                final confirm = await showDialog<bool>(
                                  ...
                                  builder: (_) => AlertDialog(
                                    ...
                                    content: const Text('سيتم استبدال قاعدة البيانات الحالية بهذه النسخة، هل أنت متأكد؟'),
                                    actions: [
                            ...
                            IconButton(
                              ...
                              tooltip: 'مشاركة',
                              onPressed: () => BackupService.instance.shareBackup(file),
                            ),
                          ],
                        ),
                      );
